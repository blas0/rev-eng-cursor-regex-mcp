...
[Skip to content](https://cursor.com/blog/fast-regex-search#main)
...
*   [Product](https://cursor.com/product)↓
    ...
    *   [Code Review](https://cursor.com/bugbot)
    *   [Cloud↗](https://cursor.com/agents)
    *   [Tab](https://cursor.com/product/tab)
...
[Sign in](https://cursor.com/dashboard)[Contact Contact sales](https://cursor.com/contact-sales?source=navbar)[Download](https://cursor.com/download)

[Blog](https://cursor.com/blog)/[research](https://cursor.com/blog/topic/research)

# Fast regex search: indexing text for agent tools

Mar 23, 2026 by Vicent Marti in [research](https://cursor.com/blog/topic/research)

### Table of Contents

↑

*   [The classic algorithm](https://cursor.com/blog/fast-regex-search#the-classic-algorithm)
*   [Inverted Indexes](https://cursor.com/blog/fast-regex-search#inverted-indexes)
*   [Trigram Decomposition](https://cursor.com/blog/fast-regex-search#trigram-decomposition)
*   [Putting it all together](https://cursor.com/blog/fast-regex-search#putting-it-all-together)
*   [Suffix Arrays: a detour](https://cursor.com/blog/fast-regex-search#suffix-arrays-a-detour)
*   [Trigram Queries with Probabilistic Masks](https://cursor.com/blog/fast-regex-search#trigram-queries-with-probabilistic-masks)
...
*   [All this, in your machine](https://cursor.com/blog/fast-regex-search#all-this-in-your-machine)
*   [Conclusions](https://cursor.com/blog/fast-regex-search#conclusions)
...
D0"the fox"nextMask pass locMask pass candidate

D0"the fox"

B Adjacency Filter (nextMask)

nextMask(`e·f`, D0):7 6 5 4 3 2 1 0 1 0 0 0 0 0 0 0

hash(`o`) = bit 7 Bit is set

C Position Filter (locMask + rotation)
